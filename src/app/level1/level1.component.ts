...
export class Level1Component implements OnInit {
  ...
  welkomstBericht() {
    ...
    this.maakRegel(
      "MACHINE",
      "Welkom op de online escape room van Scouts Sint-Tarsicius. De bedoeling is dat jij onze scouts helpt door te hacken! Volg de vragen, en denk goed na! Voor de visualiteit raden we aan om het spel op de computer te spelen. Veel escape plezier! Deze applicatie werd geschreven door Lucas Vermeulen. (Een fout gevonden? Meld op escape-room@ardu.be!)"
    );
